...
description: Detailed documentation of project and development of an smart dimmer using an ESP32 micontroller and a mobile app to control the brightness of an attached incandescent light bulb.
author: lucasmazz
